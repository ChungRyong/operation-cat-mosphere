...
* **적층 비용:** 토대 = 건설 비용, 추가 층 = 건설 비용 × 층수 (2층 ×2, 3층 ×3, 4층 ×4), 옥상 = 건설 비용 × 2
...
> **적층 비용 예시 (Fish Bone, 건설 비용 60):** 1층 60 → 2층 +120 → 3층 +180 → 4층 +240 → 옥상 +120 = 풀스택 총 720 Scrap
...
* **지출 예시:** Fish Bone 타워 2기 = 120, 여유 100 → 1기 추가 건설 or 적층
