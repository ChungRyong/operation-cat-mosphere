...
func _build_map_01() -> MapData:
	...
	m.days.append(_day(110, [
		_wg(0, J, 15, 2.0, 0), _wg(35, L, 2, 3.0, 0), _wg(50, J, 15, 1.8, 0)]))
	...
	m.days.append(_day(140, [
		_wg(0, J, 20, 1.5, 0), _wg(0, J, 20, 1.5, 1),
	...
	m.days.append(_day(160, [
		_wg(0, J, 20, 1.2, -1), _wg(30, MR, 8, 3.0, 0),
		_wg(30, L, 5, 3.0, 1), _wg(60, J, 20, 1.2, 2)]))
	...
	m.days.append(_day(200, [
		_wg(0, J, 35, 1.0, -1), _wg(40, MR, 10, 2.5, -1),
